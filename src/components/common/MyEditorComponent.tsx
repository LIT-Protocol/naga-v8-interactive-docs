...
import { DEFAULT_LIT_ACTION_CODE } from "./ExecuteJsComponent";
...
const MyEditorComponent: React.FC<MyEditorComponentProps> = ({
  ...
  const defaultCode = DEFAULT_LIT_ACTION_CODE.trim();
  ...
  function handleEditorWillMount(monaco: Monaco) {
    ...
    // extra libraries
    const libSource = `
// Global variables available in Lit Action execution context
declare const jsParams: any;
declare const publicKey: string;
declare const tokenId: string;
declare const ipfsId: string;
declare const conditions: any[];
declare const authSig: any;
declare const chain: string;

// LitActions global namespace (shorthand for Lit.Actions)
declare namespace LitActions {
  /**
   * Ask the Lit Node to sign any data using the ECDSA Algorithm with it's private key share.
   */
  function signEcdsa(params: {
    toSign: Uint8Array;
    publicKey: string;
    sigName: string;
  }): Promise<string>;
  ...
  /**
   * Ask the Lit Node to sign a message using the eth_personalSign algorithm.
   */
  function ethPersonalSignMessageEcdsa(params: {
    message: string;
    publicKey: string;
    sigName: string;
  }): Promise<string>;
   ...
   */
  function setResponse(params: { response: string }): void;
  ...
  /**
   * Check conditions using the Lit condition checking engine
   */
  function checkConditions(params: {
  ...
  /**
   * Decrypt and combine data
   */
  function decryptAndCombine(params: {
    accessControlConditions: string;
    ciphertext: string;
    dataToEncryptHash: string;
    authSig: string;
   ...
   */
  function getRpcUrl(params: { chain: string }): Promise<string>;
   ...
   */
  function broadcastAndCollect(params: {
    name: string;
    value: string;
  }): Promise<string>;
   ...
   */
  function isPermittedAction(params: {
    tokenId: string;
    ipfsId: string;
  }): Promise<boolean>;
   ...
   */
  function isPermittedAddress(params: {
    tokenId: string;
    address: string;
  }): Promise<boolean>;
   ...
   */
  function isPermittedAuthMethod(params: {
    tokenId: string;
   ...
   */
  function getPermittedActions(params: {
    tokenId: string;
   ...
   */
  function getPermittedAddresses(params: {
    tokenId: string;
  }): Promise<Array<string>>;
   ...
   */
  function getPermittedAuthMethods(params: { tokenId: string }): Promise<
    Array<{
   ...
   */
  function pubkeyToTokenId(params: {
    publicKey: string;
  }): Promise<string>;
   ...
   */
  function getLatestNonce(params: {
    address: string;
    chain: string;
  }): Promise<string>;
   ...
   */
  function signAndCombineEcdsa(params: {
    toSign: Uint8Array;
    publicKey: string;
    sigName: string;
  }): Promise<Uint8Array>;
  ...
  /**
   * Claim a key through a key identifier
   */
  function claimKey(params: { keyId: string }): any;

  /**
   * AES decrypt function
   */
  function aesDecrypt(params: {
    symmetricKey: any;
    ciphertext: any;
  }): any;
}
