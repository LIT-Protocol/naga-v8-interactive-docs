...
export const ProtectedApp: React.FC = () => {
  const { user, logout, services, isAuthenticated, initiateAuthentication } =
    useLitAuth();
  ...
  if (!isAuthenticated) {
    return (
      ...
      >
        ...
        >
          <h1
            style={{ margin: "0 0 16px 0", color: "#111827", fontSize: "32px" }}
          >
          ...
          >
            Please authenticate with Lit Protocol to access your PKP wallet and
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h2
            style={{ margin: "0 0 16px 0", color: "#0c4a6e", fontSize: "20px" }}
          >
        ...
        >
          <h2
            style={{ margin: "0 0 16px 0", color: "#111827", fontSize: "20px" }}
          >
          ...
          >
            Test your PKP by signing a custom message. This demonstrates the
            cryptographic capabilities of your Lit-powered wallet.
          </p>
          ...
          <button
            ...
            style={{
              padding: "12px 24px",
              backgroundColor:
                isSigning || !message.trim() ? "#9ca3af" : "#10b981",
              color: "white",
              border: "none",
              borderRadius: "8px",
              fontSize: "16px",
        ...
        >
          <h2
            style={{ margin: "0 0 16px 0", color: "#92400e", fontSize: "20px" }}
          >
            🚀 What You Can Do Now
          </h2>
          <div style={{ display: "grid", gap: "12px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              ...
              <span style={{ color: "#92400e" }}>
                Sign messages and transactions with your PKP
              </span>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              <span style={{ color: "#065f46", fontSize: "16px" }}>✅</span>
              <span style={{ color: "#92400e" }}>
                Execute Lit Actions with your authentication context
              </span>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              <span style={{ color: "#065f46", fontSize: "16px" }}>✅</span>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              <span style={{ color: "#065f46", fontSize: "16px" }}>✅</span>
              <span style={{ color: "#92400e" }}>
                Leverage programmable MPC wallet capabilities
              </span>
            </div>
          </div>
        </div>
