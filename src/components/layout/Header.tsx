...
export const Header = () => {
  ...
  return (
    <div className="max-w-8xl mx-auto relative text-black sticky top-0 z-50 bg-white">
      <div>
            ...
            <div className="h-full relative flex items-center justify-between gap-x-4 min-w-0 border-b border-gray-500/5 dark:border-gray-300/[0.06] pl-4 lg:pl-0 w-full">
              ...
              <div className="text-sm flex items-center gap-3 ml-auto text-[#837F7E]">
                {litAuth?.isAuthenticated && (
                  <button className="cursor-pointer" onClick={litAuth.logout} aria-label="Logout">
                    Logout
                  </button>
                )}
              </div>
