    ...
    <div style={{ maxWidth: "90%" }}>
      ...
      <GreyBoarderWhiteBgContainer style={{ marginTop: "32px" }}>
        <div>
          ...
          <p style={{ color: "#666", fontSize: "16px", lineHeight: "1.6" }}>
            The Auth Manager handles authentication flows and session
            persistence. First, select your storage plugin, then create the Auth
            Manager instance. Storage plugins handle persistence of
            authentication data, session tokens, and user preferences.
          </p>
        </div>
      ...
      >
        <div>
          ...
          >
            Before setting up the Auth Manager, it's helpful to understand the
            key components and concepts you'll be working with:
          </p>
          ...
          >
            ...
            >
              ...
              >
                A temporary cryptographic key pair generated on the client side
                that acts as a temporary identity for the client application.
                Consists of a public key (shared with Lit nodes) and a secret
                key (kept securely on the client).
              </p>
            </div>
            ...
            >
              ...
              >
                A cryptographic attestation from the Lit Protocol nodes that
                authorises your session key to act on behalf of your PKP. This
                is the "inner auth sig" that enables secure operations.
              </p>
            </div>
            ...
            >
              ...
              >
                Configurable storage solutions for persisting authentication
                state, session tokens, and user preferences. Different plugins
                offer various persistence and security levels.
              </p>
            </div>
            ...
            >
              ...
              >
                The process of creating and caching authentication context,
                including session keys and delegation signatures. This enables
                secure, persistent authentication sessions.
              </p>
            </div>
          </div>
        </div>
                        ...
                        <div>
                          ...
                          <div
                            style={{
                              fontSize: "12px",
                              color:
                                selectedStorage === key ? "#e6f3ff" : "#666",
                              marginTop: "4px",
                            }}
                          >
                            {option.description}
          ...
          <DisplayCode
            ...
            renderComponent={
              <div>
                ...
                >
                  Create an Auth Manager with your selected storage
                  configuration.
                </p>
      ...
      >
        ...
        <p style={{ margin: "0", color: "#1e3a8a", lineHeight: "1.5" }}>
          ...
          <Link
            to="/building-with-lit/setup-auth-services"
            style={{ color: "#3b82f6", textDecoration: "underline" }}
          >
            Setup the Auth Services
          </Link>{" "}
          and explore authentication flows and session management.
        </p>
      </div>
