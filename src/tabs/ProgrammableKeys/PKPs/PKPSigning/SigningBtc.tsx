...
import PkpBtcSigningComponent from "../../../../components/common/PkpBtcSigningComponent";
...
export default function PkpSignBtc() {
  ...
  return (
    <div className="tab-content">
      <h1 style={pageStyles.h1}>PKP Signing for Bitcoin</h1>

      <GreyBoarderWhiteBgContainer>
        <h2 style={pageStyles.h2}>Intro</h2>
        <p style={pageStyles.p}>
          The Lit Client provides a streamlined interface for signing Bitcoin
          transactions supporting both standard and Taproot formats using a PKP
          (Programmable Key Pair). It automatically hashes the input with{" "}
          <code>SHA-256</code> and uses either the <code>EcdsaK256Sha256</code>{" "}
          or <code>SchnorrK256Sha256</code> signature scheme.
        </p>
        <p style={pageStyles.p}>
          This guide walks you through the steps to sign data for the Bitcoin
          blockchain using a PKP and the Lit Client.
        </p>
      ...
      <GreyBoarderWhiteBgContainer>
        <PkpBtcSigningComponent
          authContext={authContext}
          pkpInfo={pkpInfo}
          setStatus={setStatus}
          assertDependenciesLoaded={assertDependenciesLoaded}
          defaultMessage="Hello from PKP Bitcoin Signing!"
          componentTitle={`Step 5: Sign Message with PKP (Bitcoin Signing)`}
        />
      </GreyBoarderWhiteBgContainer>
    </div>
  );
