...
import PkpEthSigningComponent from "../../../../components/common/PkpEthSigningComponent";
...
export default function PkpSignEth() {
  ...
  return (
    <div className="tab-content">
      <h1 style={pageStyles.h1}>PKP Signing for Ethereum</h1>

      <GreyBoarderWhiteBgContainer>
        <h2 style={pageStyles.h2}>Intro</h2>
        <p style={pageStyles.p}>
          The Lit Client offers a streamlined interface for signing data such as
          EIP-191 messages or Ethereum transactions using a PKP. The Lit Client
          automatically hashes the input with <code>keccak256</code> and signs
          it using the <code>EcdsaK256Sha256</code> signature scheme, which is
          compatible with Ethereum’s native ECDSA validation.
        </p>
        <p style={pageStyles.p}>
          This guide will walk you through the steps required to sign data for
          the Ethereum blockchain using a PKP and the Lit Client.
        </p>
      ...
      <GreyBoarderWhiteBgContainer>
        <PkpEthSigningComponent
          authContext={authContext}
          pkpInfo={pkpInfo}
          setStatus={setStatus}
          assertDependenciesLoaded={assertDependenciesLoaded}
          defaultMessage="Hello from PKP Ethereum Signing!"
          componentTitle={`Step 5: Sign Message with PKP (Ethereum Signing)`}
        />
      </GreyBoarderWhiteBgContainer>
    </div>
  );
